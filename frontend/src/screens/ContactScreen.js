        ...
        <div className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
            ...
            <p className="mt-6 text-base text-indigo-50 max-w-3xl">
              Let us know about a new educational opportunity that you think others may find valuable. We 
              personally review each submission, and appreciate you joining us in informing others about 
              new possibilities.
            </p>
          ...
          <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12 bg-slate-200">
            <h3 className="text-lg font-medium text-gray-900">Let us know about an opportunity!</h3>
            <form action="https://formsubmit.co/parvoz103@gmail.com" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            <input type="hidden" name="_next" value="https://parvoz.herokuapp.com/thankyou"/>
            <input type="hidden" name="_subject" value="New opportunity recommendation"/>
              <div>
