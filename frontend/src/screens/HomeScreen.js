        ...
        <div className="bg-slate-900">
            <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
              <div className="lg:flex">
                ...
                <h1 className="text-3xl font-extrabold tracking-tight text-gray-200 mb-8 mt-8">Recent Opportunities Posted</h1>
                ...
                <h1 className="text-3xl font-extrabold tracking-tight text-gray-200 mb-8 mt-8">Most Popular Courses</h1>
